    ...
    <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg border border-gray-200 mt-2 text-base">
      ...
      <div className="flex justify-center space-x-4 mb-6">
        <button 
          ...
          className={"px-6 py-3 rounded-full font-bold text-lg transition-all shadow-sm " + (drugType === 'acid' ? 'bg-blue-600 text-white ring-2 ring-blue-300' : 'bg-gray-100 text-gray-600 hover:bg-gray-200')}
        >
          弱酸性 (例: NSAIDs)
        </button>
        <button 
          onClick={() => handlePreset('base', 8.0)}
          className={"px-6 py-3 rounded-full font-bold text-lg transition-all shadow-sm " + (drugType === 'base' ? 'bg-indigo-600 text-white ring-2 ring-indigo-300' : 'bg-gray-100 text-gray-600 hover:bg-gray-200')}
        >
          弱塩基性 (例: 麻酔薬)
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        {/* 溶解性（イオン形） */}
        <div className="bg-blue-50 p-4 rounded-xl text-center border border-blue-200 shadow-sm">
          <div className="text-gray-600 mb-1 font-bold">水への溶解性 (イオン形)</div>
          <div className="text-4xl font-bold text-blue-600 mb-2">{ionization.toFixed(1)}%</div>
        ...
        <div className="bg-orange-50 p-4 rounded-xl text-center border border-orange-200 shadow-sm">
          <div className="text-gray-600 mb-1 font-bold">膜透過性 (分子形)</div>
          <div className="text-4xl font-bold text-orange-600 mb-2">{unionized.toFixed(1)}%</div>
          <div className="h-24 flex items-end justify-center px-4">
          ...
          <p className="mt-2 text-sm text-orange-800 font-bold">
        ...
        <Slide className="flex flex-col justify-center items-center text-center bg-gradient-to-br from-blue-50 to-white">
          <div className="max-w-4xl animate-fade-in-up">
            ...
            <p className="text-2xl md:text-3xl text-gray-600 mb-12">
              物理化学の基礎から
              <span className="font-bold text-blue-600 mx-2">生物薬剤学</span>・
              <span className="font-bold text-indigo-600 mx-2">製剤学</span>の実践へ
            </p>
            <div className="flex justify-center space-x-8">
              <div className="flex items-center text-xl text-gray-500 bg-white px-4 py-2 rounded-lg shadow-sm">
                <Brain className="w-8 h-8 mr-2 text-blue-500" /> 基礎理論
              </div>
              <ArrowRight className="text-gray-300 w-8 h-8 self-center" />
              <div className="flex items-center text-xl text-gray-500 bg-white px-4 py-2 rounded-lg shadow-sm">
                <Pill className="w-8 h-8 mr-2 text-indigo-500" /> 医薬品開発
              </div>
            </div>
        ...
        <Slide>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center h-full">
            <div>
              ...
              <div className="mt-10 p-6 bg-red-50 text-red-800 rounded-xl border-l-8 border-red-500 text-xl shadow-md">
            ...
            <div className="flex justify-center items-center">
              <div className="relative w-80 h-80 bg-gradient-to-b from-blue-100 to-orange-100 rounded-full flex items-center justify-center border-4 border-dashed border-gray-300 shadow-inner">
                ...
                <div className="z-10 bg-white p-4 rounded shadow-lg text-lg font-bold border border-gray-200">
                  Henderson-Hasselbalch式<br/>が支配する世界
                </div>
              </div>
            </div>
          </div>
        ...
        <Slide>
          ...
          <div className="flex flex-col space-y-8">
            <div className="bg-white p-6 rounded-xl shadow-sm border-l-8 border-green-500">
              <h3 className="font-bold text-2xl text-green-700 mb-2 flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="border-2 p-6 rounded-xl hover:shadow-md transition-shadow">
              ...
              <div className="border-2 p-6 rounded-xl bg-green-50 border-green-200 hover:shadow-md transition-shadow">
                ...
                <ul className="text-lg space-y-3">
                  ...
                  <li>→ 表面積が広大で血流も豊富</li>
                  <li className="font-bold text-green-700 mt-2 text-xl bg-green-100 p-2 rounded">結論: 主要な吸収部位となる</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      content: (
        <Slide>
          ...
          <div className="space-y-6">
            <div className="flex items-start bg-white border-2 border-gray-200 p-6 rounded-2xl shadow-sm hover:border-blue-300 transition-colors">
              <div className="bg-blue-100 p-4 rounded-full mr-6 text-blue-600 font-bold text-2xl w-16 h-16 flex items-center justify-center flex-shrink-0">1</div>
              <div>
            ...
            <div className="flex items-start bg-white border-2 border-gray-200 p-6 rounded-2xl shadow-sm hover:border-indigo-300 transition-colors">
              <div className="bg-indigo-100 p-4 rounded-full mr-6 text-indigo-600 font-bold text-2xl w-16 h-16 flex items-center justify-center flex-shrink-0">2</div>
              <div>
                <h4 className="font-bold text-2xl text-gray-800">pH調整剤の添加</h4>
                <p className="text-lg text-gray-600 mt-2">
                  注射剤や液剤では、バッファー（緩衝剤）を加えて、薬物が最も安定して溶けるpHに維持します。
                  <br/><span className="text-red-500 text-base">※ただし、pHを極端にしすぎると注射時に疼痛の原因になるので注意！</span>
                </p>
              </div>
            </div>

            <div className="flex items-start bg-white border-2 border-gray-200 p-6 rounded-2xl shadow-sm hover:border-purple-300 transition-colors">
              <div className="bg-purple-100 p-4 rounded-full mr-6 text-purple-600 font-bold text-2xl w-16 h-16 flex items-center justify-center flex-shrink-0">3</div>
              <div>
    ...
    },
    {
      ...
      content: (
        <Slide>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-10 rounded-2xl shadow-xl mb-12 transform hover:scale-[1.01] transition-transform">
